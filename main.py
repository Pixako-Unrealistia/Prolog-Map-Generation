...
class MapGenerator(QWidget):
    def __init__(self):
        ...
        self.prolog = Prolog()
        self.prolog.consult("random_seed.pl")  # Assuming you have a Prolog file for generating seeds
    ...
    def initUI(self):
        ...
        self.width_slider.setRange(5, 100)
        self.width_slider.setValue(100)  # Default value
        ...
        self.height_slider.setValue(100)  # Default value
    ...
    def regenerate_seed(self): # THIS IS JUST TO CHECK THAT LINKING WORKS ON MY ENV
